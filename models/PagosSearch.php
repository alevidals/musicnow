...
class PagosSearch extends Pagos
{
    ...
    {
        return [
            [['id', 'provincia_id', 'usuario_id'], 'integer'],
            [['payment', 'cart', 'nombre', 'apellidos', 'direccion', 'created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'payment', $this->payment])
            ->andFilterWhere(['ilike', 'cart', $this->cart])
